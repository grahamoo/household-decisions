...
import excel using "December 2013 LA election", firstrow sheet("Candidates") clear
drop if POSITION != 1 & POSITION != 2
tempfile DEC_2013
save "`DEC_2013'"

import excel using "December 2013 LA election", firstrow sheet("Electors") clear
